...
SCRIPTS=(
    "carwash/hamilton/hamilton_main.py"
    "carwash/sitewash/sitewatch_main.py"
    "carwash/washify/washify_main.py"
)
...
# Run the Python scripts and log the output
...
echo "All scripts have been executed. Logs can be found in $LOG_FILE" | tee -a "$LOG_FILE"
