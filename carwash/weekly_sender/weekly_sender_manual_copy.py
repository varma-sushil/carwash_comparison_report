...
if __name__=="__main__":
    ...
    monday_date_str="2024-07-29"
    friday_date_str = "2024-08-02"
    saturday_date_str = "2024-08-03"
    sunday_date_str="2024-08-04"  #Y-M-D
    ...
    # testing dates 
    monday_date_str =  "07/29/2024"
    friday_date_str =  "08/02/2024"
    saturday_date_str = "08/03/2024"
    sunday_date_str  =  "08/04/2024"  #M/D/Y
    print("washify")
    print(monday_date_str, friday_date_str, saturday_date_str, sunday_date_str)
